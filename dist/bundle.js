...
var MainPlayer = /** @class */ (function (_super) {
    ...
    MainPlayer.prototype.render = function () {
        return (React.createElement("video", { style: { width: '100%', height: '100%' } }));
    };
    return MainPlayer;
}(React.Component));
exports.default = MainPlayer;
ReactDOM.render(React.createElement(MainPlayer, { window: { width: 800, height: 600, scale: 1 } }), document.getElementById('app'));
